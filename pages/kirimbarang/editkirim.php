...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2>Pengiriman Order</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="?mod=home">Home</a>
                        </li>
                        <li>
                            <a href="?mod=daftarorder">Pengiriman</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<div class="ibox-title" align="right">
						<h5>Form Tambah Pengiriman</h5>
							<button type="button" class="btn btn-success" onClick="window.location='?mod=daftarorder'">
							<i class="fa fa-list"></i>&nbsp; Daftar Order</button>
                        </div>
                        <div class="ibox-content">
                            <form class="form-horizontal">																
								<div class="form-group">
									<label for="cboorder" class="col-sm-2 control-label">Purchase Order</label>
									<div class="col-sm-4">
								...
								<div class="form-group">	
									<label for="txtpers" class="col-sm-2 control-label">Kepada</label>	
									<div class="col-sm-4">										
										<input type="text" class="form-control" id="txtpers" disabled="disabled"/>							
									</div>	
								</div>
								<div class="form-group">	
									<label for="txtalamat" class="col-sm-2 control-label">Alamat</label>	
									<div class="col-sm-6">										
										<textarea rows='3' class="form-control" id='txtalamat' disabled="disabled"></textarea>									
									</div>	
								</div>
								<div class="form-group">
									<label for="cbopers" class="col-sm-2 control-label">Dikirim dari</label>
									<div class="col-sm-5">
										<select id="cbopers" class="select2_demo_3 form-control">
										</select>
									</div>
								</div>
								<div class="form-group">	
									<label for="txttglkirim" class="col-sm-2 control-label">Tanggal Pengiriman</label>	
									<div class="col-sm-2">	
										<div class="input-group">
                                        	<input type="text" id="txttglkirim" class="form-control" />
								...
								<div class="form-group">
									<label for="txtjml" class="col-sm-2 control-label">Jumlah Pengiriman</label>
									<div class="col-sm-2">
										<input type="number" class="form-control text-center" id="txtjml" />
									</div>						
								</div>
								<div class="form-group">
									<label for="txtkend" class="col-sm-2 control-label">Kendaraan</label>
									<div class="col-sm-2">
										<input type="text" class="form-control text-center" id="txtkend" />
									</div>						
								</div>
								<div class="form-group">
									<label for="txtpol" class="col-sm-2 control-label">Nomor Polisi</label>
									<div class="col-sm-2">
										<input type="text" class="form-control text-center" id="txtpol" />
									</div>						
								</div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label" required>Terima</label>
                                    <div class="col-sm-10">
                                    <input type="checkbox" class="js-switch" name="kdterima"/>   
									</div>
                                </div>
								<div class="form-group">
						...
						<div class="box-footer text-right" >
							<button type="button" class="btn btn-default" onClick="window.location='?mod=daftarorder'">
   ...
   <script src="js/plugins/switchery/switchery.js"></script>
	...
	<!-- javascript khusus -->
	<script src="js/editkirim.js"></script>
</body>
