...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content invoice">
					...
					<div class="row" id="judul_area"></div>	
					<div class="row">
						<div class="col-xs-12">
							<div class="col-xs-1"></div>
							<div class="box-body col-sm-10">								
								<div id="pemohon_area"></div>			
							</div>
						</div>
					</div><br>			
					<div class="row">
				...
				<section class="content invoice no-print">
				  <div class="row">						
						<div class="col-sm-12">
							<button type="button" class="btn btn-primary" id="btnback"><i class="fa fa-reply"></i>&nbsp; Back</button>	
		...
		<script src="js/prevujs.js" type="text/javascript"></script>
