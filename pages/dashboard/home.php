	...
	<div id="page-wrapper" class="gray-bg">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Selamat Datang di EA+ <?php 
										$user 	= ucwords($_SESSION['namalengkap']);
										echo "&nbsp; $user";
									?></span>
                </li>
                <li class="dropdown">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                            <?php 
							$query = mysql_query("select *from userapp where online = '1'") or die(mysql_error());
		...
		if(mysql_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
			...
			while($r = mysql_fetch_array($query)){	
				...
				echo '<tr>';
					...
					echo strtoupper ('<td>'.$r['nama_lengkap'].'</td>');	
					echo '<td align ="center">'.$r['ipaddress'].'</td>';	
					echo '</tr>';
