...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-folder"></i>Master</a></li>
                ...
                <section class="content">
					<div class="box box-solid"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form Customer</h4>							
						</div><hr>
						
						<div class="box-body">
							<form class="form-horizontal">
								<div class="form-group">	
									<label for="txtperusahaan" class="col-sm-2 control-label">Nama Perusahaan</label>	
									<div class="col-sm-6">										
										<input type="text" class="form-control" id="txtperusahaan"/>
									</div>	
								</div>								
								<div class="form-group">	
									<label for="alamat" class="col-sm-2 control-label">Alamat</label>	
									<div class="col-sm-6">										
										<textarea rows='3' class="form-control" id='txtalamat'></textarea>									
									</div>	
								</div>
								<div class="form-group">	
									<label for="txttelp" class="col-sm-2 control-label">Kota</label>	
									<div class="col-sm-4">					
										<input type="text" id="txtkota" class="form-control" />																			
									</div>	
								</div>
                                <div class="form-group">	
									<label for="txtnama" class="col-sm-2 control-label">Contact Person</label>	
									<div class="col-sm-6">										
										<input type="text" class="form-control" id="txtnama"/>
										<input type="hidden" class="form-control" id="txtkodecustomer"/>									
									</div>	
								</div>	
								<div class="form-group">	
									<label for="txttelp" class="col-sm-2 control-label">No Telp</label>	
									<div class="col-sm-4">	
										<div class="input-group">
											<div class="input-group-addon">
                                                <i class="fa fa-phone"></i>
                                            </div>										
												<input type="text" id="txttelp" class="form-control" />	
										</div>								
									</div>	
								</div>
								<div class="form-group">	
									<label for="txttelp" class="col-sm-2 control-label">No HP</label>	
									<div class="col-sm-4">	
										<div class="input-group">
											<div class="input-group-addon">
                                                <i class="fa fa-phone"></i>
                                            </div>										
												<input type="text" id="txthp" class="form-control" />	
										</div>								
									</div>	
								</div>
                                <div class="form-group">	
						...
						<div class="box-footer text-right" >	
							<button type="button" class="btn btn-danger" onClick="window.location='?mod=cust'">
		...
		<script src="js/newcust.js" type="text/javascript"></script>	
