...
<html>
    ...
    <body class="skin-blue">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">										
								<div class="box-body">
									<label></label>
									<div class="row">
										<div class="col-lg-6" id="searchbykode">
											<div class="input-group">												
										...
										<div class="col-sm-2">		
											<span class="help-block"><a href="?mod=newcust">&nbsp;| &nbsp; Add New Customer</a></span>
										</div>		
									</div><br>									
            ...
            <div class="modal-dialog">
                <div class="modal-content">
					...
					<div class="modal-footer clearfix" id="btnexec">
						...
						<button type="button" class="btn btn-primary pull-left" id="btndel"><i class="fa fa-check"></i> Ya</button>
					</div>
		...
		<script src="js/cust.js" type="text/javascript"></script>
