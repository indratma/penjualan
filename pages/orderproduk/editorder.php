...
<html>
    ...
    <body class="skin-blue">
                ...
                <section class="content">
					<div class="box box-solid"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form Edit Order</h4>							
						</div><hr>
						
						<div class="box-body">
							<form class="form-horizontal">
								<div class="form-group">	
									<label for="txttglorder" class="col-sm-3 control-label">Tanggal Order</label>	
									<div class="col-sm-2">	
										<div class="input-group">
								...
								<div class="form-group">
									<label for="cbocustomer" class="col-sm-3 control-label">Customer</label>
									<div class="col-sm-4">
								...
								<div class="form-group">	
									<label for="txtperson" class="col-sm-3 control-label">Contact Person</label>	
									<div class="col-sm-4">										
								...
								<div class="form-group">	
									<label for="txttelp" class="col-sm-3 control-label">No Telepon</label>	
									<div class="col-sm-4">	
										<div class="input-group">
											<div class="input-group-addon">
								...
								<div class="form-group">	
									<label for="txtnamabrg" class="col-sm-3 control-label">Nama Barang</label>	
									<div class="col-sm-4">										
								...
								<div class="form-group">
									<label for="txtbiaya" class="col-sm-3 control-label">Total Biaya</label>
									<div class="col-sm-2">
		...
		<script src="js/myeditorder.js" type="text/javascript"></script>	
