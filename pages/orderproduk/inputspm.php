					...
					<div class="ibox-title" align="right">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
								...
								<div class="form-group">	
									<label for="tglorder" class="col-sm-2 control-label">Tanggal Order</label>	
									<div class="col-sm-4">										
										<input type="text" class="form-control" id="tglorder" disabled="disabled"/>							
									</div>	
								</div>
								<div class="form-group">	
									<label for="txtbarang" class="col-sm-2 control-label">Barang</label>	
									<div class="col-sm-4">										
										<input type="text" class="form-control" id="txtbarang" disabled="disabled"/>							
									</div>	
								</div>
								<div class="form-group">	
									<label for="txtjml" class="col-sm-2 control-label">Jumlah</label>	
									<div class="col-sm-4">										
										<input type="text" class="form-control" id="txtjml" disabled="disabled"/>							
									</div>	
								</div>
								<div class="form-group">	
