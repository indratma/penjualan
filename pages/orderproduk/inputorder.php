            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="?mod=daftarorder">Order</a>
                        </li>
                        <li class="active">
                ...
                <div class="col-lg-12">
					...
					<div class="ibox-title" align="right">
                        ...
                        <div class="ibox-content">
							...
							<div class="form-group">	
									<label for="txttglorder" class="col-sm-2 control-label">Tanggal Order</label>	
									<div class="col-sm-2">	
										<div class="input-group">
                                        	<input type="text" id="txttglorder" class="form-control" />
								...
								<div class="form-group">
									<label for="cbocustomer" class="col-sm-2 control-label">Customer</label>
									<div class="col-sm-4">
										<select id="cbocustomer" class="select2_demo_3 form-control">
										</select>
									</div>
									<div class="col-sm-3">		
								...
								<div class="form-group">	
									<label for="txtperson" class="col-sm-2 control-label">Contact Person</label>	
									<div class="col-sm-4">										
										<input type="text" class="form-control" id="txtperson" disabled="disabled"/>							
									</div>	
								</div>
								<div class="form-group">	
									<label for="alamat" class="col-sm-2 control-label">Alamat</label>	
									<div class="col-sm-6">										
										<textarea rows='3' class="form-control" id='alamat' disabled="disabled"></textarea>									
									</div>	
								</div>
								<div class="form-group">	
									<label for="txttelp" class="col-sm-2 control-label">No Telepon</label>	
									<div class="col-sm-4">	
										<div class="input-group">
											<div class="input-group-addon">
                                                <i class="fa fa-phone"></i>
                                            </div>										
												<input type="text" class="form-control" id="txttelp" disabled="disabled"  />	
										</div>								
									</div>	
								</div>						
								<div class="form-group">
									<label for="cboarmada" class="col-sm-2 control-label">Barang</label>
									<div class="col-sm-4">
										<select id="cbobarang" class="select2_demo_3 form-control">
										</select>
									</div>
								</div>
								<div class="form-group">
									<label for="txtjml" class="col-sm-2 control-label">Jumlah Order</label>
									<div class="col-sm-2">
										<input type="number" class="form-control text-center" id="txtjml"  placeholder="Satuan Kg"/>
									</div>						
								</div>
								<div class="form-group">
									<label for="txtbiaya" class="col-sm-2 control-label">Harga</label>
									<div class="col-sm-2">
										<input type="text" class="form-control text-center" id="txtbiaya"  placeholder="0"/>
									</div>								
								</div>
								<div class="form-group">
						...
						<div class="box-footer text-right" >
							<button class="btn btn-primary  dim btn-outline" type="button" id="btnconfirm"><i class="fa fa-save (alias)">&nbsp; Simpan</i></button>
						</div>
						</div>						
						<br>						
                        </div>
